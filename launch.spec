...
a = Analysis(
    ...
    binaries=[],
    datas=[],
    hiddenimports=['resume_core', 'PyQt5', 'PyQt5.QtWidgets', 'PyQt5.QtCore', 'PyQt5.QtGui'],
    hookspath=[],
    runtime_hooks=[],
    excludes=[
        # Exclude heavy ML stacks by default for desktop-only usage
        'torch', 'torchvision', 'torchaudio', 'transformers', 'sentence_transformers',
        'tensorflow', 'keras', 'sklearn', 'pyarrow',
        # Exclude scipy stack unless explicitly needed
